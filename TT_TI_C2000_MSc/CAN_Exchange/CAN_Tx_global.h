...
#ifndef CAN_TX_GLOBAL_H_
#define CAN_TX_GLOBAL_H_
...
typedef struct {
	...
	Uint16 canDLC;
	Uint16 period;		/* Message period in TASK EXECUTIONS */
	Uint16 offset;		/* Message offset in TASK EXECUTIONS - use to control message spacing */
} canTxMessage_t;
...
/*******************************************************************************/
/* Tx Message ID 0x7AB (Template) */
/*******************************************************************************/

/* Specify variables for CAN Message */
struct CAN_DATA_VARS_TX_7AB{
...
union CAN_DATA_TX_7AB{
	Uint32 rawData[2];
	struct CAN_DATA_VARS_TX_7AB dataVars;
};
extern union CAN_DATA_TX_7AB canData_Tx_7AB;

/* Assign CAN ID to message */
extern canTxMessage_t canMessage_Tx_7AB;
...
/* Join CAN message with raw data array (2 x 32bit array) */
union CAN_DATA_TX_651{
	Uint32 rawData[2];
	struct CAN_DATA_VARS_TX_651 dataVars;
};
extern union CAN_DATA_TX_651 canData_Tx_651;

/* Assign CAN ID to message */
extern canTxMessage_t canMessage_Tx_651;
...
extern canTxMessage_t* CAN_TxMessages[];

extern const unsigned int numTxCANMsgs;

#endif /* CAN_TX_GLOBAL_H_ */
